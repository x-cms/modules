...
class RouteListCommand extends Command
{
    ...
    /**
     *  Contains all module's root namespace
     *
     * @var array
     */
     ...
     * @var array
     */
    protected $headers = ['Domain', 'Method', 'URI', 'Name', 'Action', 'Middleware', 'Module Namespace'];
    ...
    {
        $this->module = $this->ask('Module alias name?', 'all');
        $this->setModulesNamespace();
        $this->fire();
    }
    ...
    public function setModulesNamespace()
    {
        ...
        $this->modulesNamespace =  collect($modules)->pluck('namespace');
    }
